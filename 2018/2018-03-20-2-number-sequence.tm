...
<\body>
  ...
  <math|x<rsub|1>=2> \<#4EE5\>\<#53CA\> <math|x<rsub|n+1>=<sqrt|x<rsub|n><rsup|2>+8>-<sqrt|x<rsub|n><rsup|2>+3>>
  \<#786E\>\<#5B9A\>\<#FF0C\>
  ...
  \<#8BC1\>\<#660E\>: (1) \<#7531\> <math|x<rsub|n+1>=<frac|5|<sqrt|x<rsub|n><rsup|2>+8>+<sqrt|x<rsub|n><rsup|2>+3>>>
